...
if ( ! function_exists( 'digitalallies_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function digitalallies_posted_on() {
...
if ( ! function_exists( 'digitalallies_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function digitalallies_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( 'digitalallies_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function digitalallies_entry_footer() {
...
if ( ! function_exists( 'digitalallies_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function digitalallies_post_thumbnail() {
		...
		if ( is_singular() ) :
			...
			<div class="post-thumbnail">
				<?php the_post_thumbnail('bwcet_610-462'); ?>
			</div><!-- .post-thumbnail -->
