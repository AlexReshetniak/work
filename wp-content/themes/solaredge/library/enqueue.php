...
if ( ! function_exists( 'digitalallies_scripts' ) ) :
    function digitalallies_scripts() {
        ...
        // App JS
        wp_enqueue_script( 'main-scripts', get_stylesheet_directory_uri() . '/dist/assets/js/' . digitalallies_asset_path( 'app.js' ), array('jquery'), '1.0.0', true );
    ...
    add_action( 'wp_enqueue_scripts', 'digitalallies_scripts' );
endif;
