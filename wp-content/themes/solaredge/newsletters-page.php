...
?>
  <div class="newsletters-list m-listing">
    <div class="container">
      <?php $newsletters_posts = get_posts( array(
        'numberposts'      => 9,
        'category'         => 0,
        'orderby'          => 'date',
        'order'            => 'DESC',
      ...
      if ( $newsletters_posts ): ?>
        <div class="newsletters-list-wrapper m-listing__wrapper">
          <?php foreach ( $newsletters_posts as $post ):
            setup_postdata( $post );
            if ( wp_is_mobile() ) {
            ...
            ?>
            <div class="newsletters-list__item m-listing__item">
              <div class="newsletters-list__item-image m-listing__item-image">
                <?php echo $image; ?>
              </div>
              <div class="newsletters-list__item-title m-listing__item-title">
                <?php the_title(); ?>
              </div>
              <div class="newsletters-list__description m-listing__item-description">
